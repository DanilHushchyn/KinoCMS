...
class GalleryController(ControllerBase):
    ...
    def create_gallery(
        ...
        Please provide:
          - **images**  of images ids for initial data for gallery
        ...
        """
        result = self.gallery_service.create(body=body)
        return result
    ...
    def update_gallery(
        ...
        Returns:
          ...
          - **500**: Internal server error if an unexpected error occurs.
        """
        result = self.gallery_service.update(body=body,
