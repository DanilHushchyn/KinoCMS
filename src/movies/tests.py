...
class TestCinemaAdminController:
    ...
    @pytest.mark.parametrize("mv_slug,expected_status",
                             [
                                 (
    ...
    def test_get_movie(self, mv_slug, expected_status):
        response = self.client.get(f"/{mv_slug}/",
    ...
    @pytest.mark.parametrize("mv_slug, payload, expected_status",
                             [
                                 (
                                         "movie-01",
                                         {
    ...
    def test_update_movie(self, mv_slug, payload, expected_status):
        response = self.client.patch(f"/{mv_slug}/", json=payload,
                                     headers=self.headers)
        assert response.status_code == expected_status
    ...
    def test_get_all_movie_techs(self):
        response = self.client.get("/techs/",
                                   headers=self.headers)
        assert response.status_code == 200
    ...
    def test_get_all_movie_participants_grouped(self):
        response = self.client.get("/participants-grouped/",
                                   headers=self.headers)
        assert response.status_code == 200
    ...
    def test_get_all_movie_legal_ages(self):
        response = self.client.get("/legal-ages/",
                                   headers=self.headers)
        assert response.status_code == 200
    ...
    def test_delete_movie(self, mv_slug, expected_status):
        response = self.client.delete(f"/{mv_slug}/",
                                      headers=self.headers)
        assert response.status_code == expected_status
