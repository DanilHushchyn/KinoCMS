    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('card_img', models.OneToOneField(null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='movie_card', to='core.image')),
        ...
        migrations.AddField(
            ...
            name='person',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='movies.movieparticipantperson'),
        ),
        migrations.AddField(
            model_name='movieparticipant',
            name='role',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='movies.movieparticipantrole'),
        ),
