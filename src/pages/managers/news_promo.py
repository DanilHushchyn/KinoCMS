"""Custom manager for model NewsPromo"""
...
class NewsPromoManager(models.Manager):
    ...
    def get_by_slug(self, np_slug: str) -> "NewsPromo":
        ...
        """
        try:
            news_promo = self.model.objects.select_related(
                "seo_image", "banner", "gallery"
            ).get(slug=np_slug)
        except self.model.DoesNotExist:
            msg = _("Не знайдено: немає збігів новин чи акцій " "на заданному запиті.")
