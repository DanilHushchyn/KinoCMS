...
class Page(models.Model):
    ...
    banner = models.ForeignKey('core.Image', on_delete=models.CASCADE,
...
class News_Promo(models.Model):
    ...
    card_img = models.ForeignKey('core.Image', on_delete=models.CASCADE,
                                 null=True, related_name='np_card')
    cinema = models.ForeignKey('cinemas.Cinema', on_delete=models.CASCADE, null=True)
    date_created = models.DateTimeField(auto_now_add=True, null=True)
    active = models.BooleanField(null=True)
...
class ETEndBBanner(models.Model):
    img = models.ForeignKey('core.Image', on_delete=models.CASCADE,
                            null=True)
