...
class TestCinemaAdminController:
    ...
    @pytest.mark.parametrize("pg_slug,expected_status",
                             [
                                 (
    ...
    def test_get_page(self, pg_slug, expected_status):
        response = self.client.get(f"/{pg_slug}/",
    ...
    @pytest.mark.parametrize("pg_slug, payload, expected_status",
                             [
                                 (
                                         "stornka-03",
                                         {
    ...
    def test_update_page(self, pg_slug, payload, expected_status):
        response = self.client.patch(f"/{pg_slug}/", json=payload,
                                    headers=self.headers)
        assert response.status_code == expected_status
    ...
    def test_delete_page(self, pg_slug, expected_status):
        response = self.client.delete(f"/{pg_slug}/",
                                   headers=self.headers)
        assert response.status_code == expected_status
