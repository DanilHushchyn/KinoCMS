...
from src.cinemas.schemas.hall import HallCardOutSchema, HallClientOutSchema
from src.cinemas.schemas.hall import HallInSchema
from src.cinemas.schemas.hall import HallOutSchema
from src.cinemas.schemas.hall import HallSchemaOutSchema
    ...
    @http_get(
        ...
        openapi_extra={
            ...
            "responses": errors_to_docs(
                {
                    404: [NotFoundExceptionError(cls_model=Hall)],
            ...
            "responses": errors_to_docs(
                {
                    ...
                    404: [
                        ...
                        NotFoundExceptionError(cls_model=Tech, field="tech"),
                    ],
                    409: [NotUniqueFieldExceptionError(field="number")],
                    422: [UnprocessableEntityExceptionError()],
                }
            ),
        },
